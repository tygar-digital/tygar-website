  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'glow-mint':    '0 4px 20px rgba(126,255,218,0.25)',
        'glow-cyan':    '0 4px 20px rgba(126,255,218,0.15)',
        'glow-violet':  '0 4px 20px rgba(126,255,218,0.15)',
        'glow-green':   '0 4px 20px rgba(126,255,218,0.15)',
      },
      animation: {
